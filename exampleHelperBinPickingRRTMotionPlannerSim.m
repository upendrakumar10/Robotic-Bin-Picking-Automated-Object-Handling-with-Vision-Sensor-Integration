function [planPath, shortPath, interpolatePath]  =  exampleHelperBinPickingRRTMotionPlannerSim(partID,partGT,startConfig,endConfig,pathType) %#codegen
%This function is for internal use only and may be removed in the future.
%exampleHelperBinPickingRRTMotionPlannerSim is a motion planner function in a collision environment
...
%   with respect to vertical Z-axis.
